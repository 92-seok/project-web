    ...
    <header className='sticky top-0 z-40 bg-background/85 backdrop-blur-md'>
      ...
      <div className='h-20 bg-background/80 border-b border-border/60 relative'>
        <div className='flex items-center justify-between h-full px-4 md:px-8 max-w-screen-xl mx-auto'>
          ...
          {/* 모바일: 로고 좌측 */}
          <Link to='/' className='md:hidden font-editorial text-[1.6rem] md:text-[1.75rem] font-bold tracking-tight text-foreground'>
            PAWMART
          </Link>
          ...
          <div className='flex items-center gap-2 flex-1 justify-end'>
            ...
            {/* 장바구니 */}
            <Link to='/cart'>
              <Button variant='ghost' size='icon' className='relative' aria-label='장바구니'>
      ...
      <nav className='h-11 bg-primary w-full hidden md:block'>
        <div className='flex items-center gap-7 px-8 h-full max-w-screen-xl mx-auto'>
