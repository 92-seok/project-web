...
function ProfileSection() {
  ...
  const handleAddressChange = (
    ...
    newRoadAddress: string,
    newJibunAddress: string,
  ) => {
      ...
      <div>
        ...
        <div className="space-y-4">
          <Field
            ...
            required
          />
          <Field label="로그인 아이디" value={user?.loginId ?? ""} disabled />
          <Field
            label="전화번호"
            value={phone}
...
function WithdrawSection() {
  ...
  return (
    <div className="max-w-md">
      ...
      <h2 className="font-editorial text-xl font-bold mb-3">회원 탈퇴ㄹ</h2>
      <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
        탈퇴 시 계정과 관련된 모든 데이터가 영구적으로 삭제되며 복구할 수
        없어요.
      </p>
      <button
        type="button"
